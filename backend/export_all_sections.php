...
<head>
    ...
    <title>Export All Statements</title>
</head>
            ...
            <table id="table_id" class="table-bordered w-100 text-center">
                ...
                <tbody>
                    ...
                    foreach (glob('./*', GLOB_ONLYDIR) as $dir) {
                        ...
                        if ($section == '__MACOSX' || $section == 'admin' || $section == 'test' || $section == 'zip_files')
                            continue;
                        $displaySection = strtoupper(($section));
                        echo "<tr> <td colspan='11'> $displaySection SECTION</td> </tr>";
